...
export const en = {
    ...
    askApiSettings: {
        ...
        imageStyleAnalysis: 'Image Style Analysis',
        imageStyleAnalysisFooter: 'Used only to extract reusable prompts from uploaded GPT Image 2 style references.',
        openAIKey: 'OpenAI API Key',
        openAIKeyPlaceholder: 'sk-...',
        imageStyleConfigured: 'Ready for style extraction',
        imageStyleConfiguredSubtitle: 'Saved custom styles can be refined into reusable prompts',
        imageStyleNotConfigured: 'Prompt extraction unavailable',
        imageStyleNotConfiguredSubtitle: 'Custom styles still work with reference images until this key is saved',
    },
    ...
    agents: {
        ...
        customImageStyleMissingOpenAIKey: 'OpenAI API Key is required before prompt extraction can run.',
