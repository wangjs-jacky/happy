...
export const en = {
    ...
    agents: {
        ...
        scheduleManagerPresetPlan: 'Plan today',
        scheduleManagerPresetReviewPool: 'Review task pool',
        scheduleManagerPresetReset: 'Weekly reset',
        scheduleDashboardTitle: 'Schedule Manager',
        scheduleDashboardBody: 'Read TT on the left, shape the plan in the center, and prepare confirmed actions on the right.',
        scheduleStatusOnline: ({ machine }: { machine: string }) => `Ready on ${machine}`,
        scheduleStatusOffline: 'Select an online machine',
        scheduleOfflineHint: 'The workspace can prepare prompts now. Sending needs an online machine.',
        scheduleContextRailTitle: 'Read',
        schedulePlanLaneTitle: 'Decide',
        scheduleExecutionRailTitle: 'Act',
        schedulePlanProtocolTitle: 'TT protocol',
        scheduleProtocolReadFirst: 'Read facts first',
        scheduleProtocolJudge: 'Separate fixed work from movable work',
        scheduleProtocolConfirmFirst: 'Ask before changing TT',
        scheduleModuleTodayLabel: 'Today',
        scheduleModuleTodayTitle: 'Today map',
        scheduleModuleTodayBody: 'Separate hard commitments, movable tasks, and items that need a decision.',
        scheduleModuleTodayMetric: 'TT today + completed',
        scheduleModulePoolLabel: 'Pool',
        scheduleModulePoolTitle: 'Task pool',
        scheduleModulePoolBody: 'Group undated tasks by project, energy, and missing context before scheduling.',
        scheduleModulePoolMetric: 'Undated backlog',
        scheduleModuleCalendarLabel: 'Calendar',
        scheduleModuleCalendarTitle: 'Time blocks',
        scheduleModuleCalendarBody: 'Convert the next actions into realistic blocks without overfilling the day.',
        scheduleModuleCalendarMetric: 'Plan after confirmation',
        scheduleModuleReviewLabel: 'Review',
        scheduleModuleReviewTitle: 'Review loop',
        scheduleModuleReviewBody: 'Use completion, overdue work, and abandoned tasks to improve tomorrow.',
        scheduleModuleReviewMetric: 'Close the loop',
        scheduleActionsTitle: 'Agent modules',
        scheduleOpenChat: 'Chat',
        scheduleActionPlanToday: 'Generate today map',
        scheduleActionPlanTodayBody: 'Read TT and draft the execution order.',
        scheduleActionReviewPool: 'Clean task pool',
        scheduleActionReviewPoolBody: 'Pick what deserves a date before changing TT.',
        scheduleActionSyncTt: 'Sync TT',
        scheduleActionSyncTtBody: 'Refresh today, completed, pool, and overdue state.',
        scheduleActionWeeklyReset: 'Weekly reset',
        scheduleActionWeeklyResetBody: 'Summarize risks and propose a lighter week.',
        scheduleRunInChat: 'Write to Chat',
        scheduleChatPanelTitle: 'Chat handoff',
        schedulePromptReady: 'Prompt ready',
        schedulePromptEmpty: 'No prompt',
        scheduleChatPanelReady: ({ action }: { action: string }) => `${action} is written into Chat. Review it, then send when ready.`,
        scheduleChatPanelEmpty: 'Use a module or command to prepare a TT-aware prompt, then continue in Chat.',
        scheduleChatCollapsed: 'Chat stays available for context and TT write confirmations.',
