...
export const en = {
    delivery: {
        tunnelMissing: "The execution machine needs cloudflared installed before it can open a temporary tunnel.",
        hostingUnconfigured: "Cloud hosting is not configured. Configure Cloudflare first.",
        published: "Last publication succeeded",
        saved: "Delivery preference saved · applies from your next message",
        updatedElsewhere: "Delivery preference updated on another device",
        title: "Delivery settings",
        away: "Away from computer",
        description: "Prefer links and attachments accessible on your phone",
        scope: "Applies to all sessions and syncs across devices",
        timing: "Applies from your next message; running tasks are unchanged",
        previewMode: "Web preview mode",
        tunnel: "Temporary tunnel",
        tunnelDescription: "No Cloudflare account. Execution machine and session must remain running; up to 24 hours.",
        hosted: "Cloud hosting",
        hostedDescription: "Upload static pages for a 24-hour preview, available after the execution machine shuts down.",
        configure: "Configure Cloudflare",
        unconfigured: "Not configured",
        unverified: "Configured · awaiting verification",
        verified: "Last check passed",
        authorizationError: "Authorization issue · check token and permissions",
        verificationUnavailable: "Unable to verify right now",
        check: "Check connection",
        checking: "Checking connection…",
        saveAndCheck: "Save and check",
        tokenConnection: "Use Account ID and API Token; saved tokens are never displayed.",
        enabledLabel: "Away from computer: on",
        disabledLabel: "Away from computer: off",
        publicationFailed: "Publication failed; retry or check configuration",
        publicationAuthError: "Cloudflare authorization failed. Update configuration.",
        retryPublication: "Request publication again",
        useTunnelOnce: "Use temporary tunnel this time",
        retryRequest: "Please republish this preview using its original preview mode.",
        tunnelOnceRequest: "Please republish this preview using a temporary tunnel this time only. Keep my global preference unchanged.",
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'All accounts',
        codexUsageUnattributed: 'Unattributed',
        codexUsageSelectAccount: 'Select an account to view its remaining quota.',
        codexUsageUnattributedHint: 'Local Codex sessions without an explicit Paws account remain unattributed.',
