...
export const en = {
    ...
    agents: {
        ...
        scheduleDashboardTitle: 'Schedule command deck',
        scheduleDashboardBody: 'Read TT first, turn the task pool into a concrete plan, and keep chat available for decisions that need context.',
