...
export const en = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Generate now',
        imageEffectNeedsPhoto: 'Add a photo first',
        imageEffectMachineOffline: 'Machine offline',
        imageEffectGenerating: 'Generating...',
        ...
        imageStylePhotoToStyledMotion: 'Portrait styles',
        imageStyleJapaneseCinemaFilm: 'Japanese live-action film',
        imageStyleJapaneseCinemaFilmHint: 'Natural 35mm cinema color, soft practical light, realistic skin, and quiet observational framing.',
        imageStyleHanddrawnAnimeFilm: 'Hand-drawn animated film',
        imageStyleHanddrawnAnimeFilmHint: 'Refined 2D linework, cel-painted characters, and a tactile watercolor-gouache setting.',
        imageStyle90sCelAnimation: '90s cel animation',
        imageStyle90sCelAnimationHint: 'Hand-inked contours, two-step cel shading, painted backgrounds, and subtle analog grain.',
        imageStyleSeinenMangaBw: 'Black-and-white seinen manga',
        imageStyleSeinenMangaBwHint: 'Precise adult manga linework, feathered shadows, stable screentones, and pure grayscale.',
        imageStyleCyberpunkGraphicNovel: 'Cyberpunk graphic novel',
        imageStyleCyberpunkGraphicNovelHint: 'Bold ink, painterly cel shading, selective halftone, and restrained cyan-magenta light.',
        imageStyleAbstractScreenprintCollage: 'Abstract screenprint collage',
        imageStyleAbstractScreenprintCollageHint: 'Risograph ink, cut-paper geometry, tactile registration, and a focused five-color palette.',
        imageStyleInkWashPortrait: 'Ink-wash portrait',
        imageStyleInkWashPortraitHint: 'Layered charcoal brushwork, mineral-gray washes, paper texture, and a restrained cinnabar accent.',
        imageStyleVintageEditorialFilm: 'Vintage editorial film',
        imageStyleVintageEditorialFilmHint: 'Authentic 1970s-90s magazine portrait photography with tactile grain and balanced faded color.',
        imageStyleCinematicRealism: 'Cinematic realism',
        imageStyleCinematicRealismHint: 'Identity-faithful live-action portraiture with controlled light, refined contrast, and filmic color.',
