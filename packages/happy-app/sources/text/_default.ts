...
export const en = {
    ...
    agents: {
        ...
        customImageStyleProgressMessage: 'Prompt extraction is running. This model call is not streamed, so the app shows elapsed time until the final Prompt is returned.',
