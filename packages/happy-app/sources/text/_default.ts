...
export const en = {
    ...
    interactivePreviews: {
        ...
        cloudflareDescription: 'No login required. Ask the assistant to publish via Cloudflare. The session machine needs cloudflared installed.',
        sessionLifetime: 'Available while the session and its machine are running, for up to 24 hours.',
        connection: 'Connection',
        loading: 'Loading connection…',
        unavailable: 'Vercel previews are unavailable on this Happy Server.',
        disconnected: 'Not connected',
        connected: ({ name }: { name: string }) => `Connected to ${name}`,
        project: 'Preview project',
        connect: 'Connect Vercel',
        reconnect: 'Reconnect Vercel',
        disconnect: 'Disconnect Vercel',
        disconnectTitle: 'Disconnect Vercel?',
        disconnectBody: 'New Vercel previews will stop immediately. Existing Vercel previews are removed when possible.',
        ...
        retry: 'Retry',
        disclosure: 'Preview links are public. Their lifetime depends on the provider: Vercel previews are scheduled for deletion after 24 hours; Cloudflare previews last while the session and its machine are running, for up to 24 hours.',
