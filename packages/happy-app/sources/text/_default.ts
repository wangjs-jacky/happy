...
export const en = {
    ...
    sessionInfo: {
        ...
        shareToOpenBirdSubtitle: 'Publish this session as a shareable web page',
        shareToOpenBirdExistingTitle: 'Already shared',
        shareToOpenBirdExistingMessage: ({ url }: { url: string }) => `This session was already shared:\n${url}`,
        shareToOpenBirdCopyExisting: 'Copy existing link',
        shareToOpenBirdRepublish: 'Republish',
        shareToOpenBirdCopiedMessage: ({ url }: { url: string }) => `Link copied to clipboard:\n${url}`,
