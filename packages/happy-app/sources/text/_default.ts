...
export const en = {
    ...
    agentSpace: {
        ...
        companion: {
            ...
            tipSleepWindowBody: 'Protect the time window first, and improve one habit at a time.',
            ...
            actionExerciseTitle: 'Record exercise',
            actionExercisePrompt: "Help me record today's exercise. I'll add the activity type, duration, or a screenshot.",
            actionDietTitle: "Record today's diet",
            actionDietPrompt: "Help me record today's diet. I'll add the food, portions, or photos.",
            actionWeeklyTitle: 'Summarize this week',
