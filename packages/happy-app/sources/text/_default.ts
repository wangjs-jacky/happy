...
export const en = {
    ...
    session: {
        ...
        continueBoundary: "New session",
        continueWaiting: "Waiting for your message.",
        ...
        continueHistoryUnavailable: "The previous session was deleted or is no longer available. Its history cannot be loaded.",
