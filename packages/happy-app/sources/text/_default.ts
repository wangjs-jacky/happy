...
export const en = {
    ...
    sessionInfo: {
        ...
        shareOpenBirdLoadFailed: 'Could not load the full session before sharing.',
        shareOpenBirdFailed: 'Failed to share with OpenBird.',
        shareHappy: 'Share with Happy Page',
        shareHappySubtitle: 'Publish a Happy-styled public page',
        shareHappyConfirmTitle: 'Publish Happy share page?',
        shareHappyConfirmMessage: 'This publishes the current session as a public Happy page. Text and image attachments may be included; images are uploaded as publicly accessible copies. Anyone with the link can view or download the shared content.',
        shareHappyPublish: 'Publish',
        shareHappySuccess: 'Happy share link ready',
        shareHappyFailed: 'Failed to publish Happy share page.',
