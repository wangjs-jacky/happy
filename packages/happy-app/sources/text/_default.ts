...
export const en = {
    ...
    devTools: {
        ...
        switchOtaVersion: 'Switch and Lock OTA Version',
        ...
        viewLogs: 'View Logs',
        ota: 'OTA',
        otaFooter: 'See this device\'s current acceptance OTA version, and switch-lock to a specific preview history version (device-only).',
        otaVersionsSubtitle: 'View acceptance version / switch-lock preview history',
        ...
        lockToVersionMessage: ({ title, subtitle, message }: { title: string; subtitle: string; message?: string }) => `${title}\n${subtitle}${message ? `\n\n${message}` : ''}\n\nThis device will switch and lock to this OTA version, then reload immediately. Other devices are not affected.`,
        switchAndReload: 'Switch and lock',
