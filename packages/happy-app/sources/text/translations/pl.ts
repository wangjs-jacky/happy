...
export const pl: TranslationStructure = {
    delivery: {
        tunnelMissing: "Aby otworzyć tunel tymczasowy, na komputerze wykonującym zadanie musi być zainstalowany cloudflared.",
        hostingUnconfigured: "Hosting w chmurze nie jest skonfigurowany. Najpierw skonfiguruj Cloudflare.",
        published: "Ostatnia publikacja pomyślna",
        saved: "Ustawienia udostępniania zapisane · obowiązują od następnej wiadomości",
        updatedElsewhere: "Ustawienia udostępniania zmieniono na innym urządzeniu",
        title: "Ustawienia udostępniania",
        away: "Z dala od komputera",
        description: "Preferuj linki i załączniki dostępne na telefonie",
        scope: "Dotyczy wszystkich sesji i synchronizuje się między urządzeniami",
        timing: "Obowiązuje od następnej wiadomości; nie wpływa na trwające zadania",
        previewMode: "Tryb podglądu strony",
        tunnel: "Tunel tymczasowy",
        tunnelDescription: "Konto Cloudflare nie jest wymagane. Komputer wykonujący zadanie i sesja muszą pozostać aktywne; maksymalnie 24 godziny.",
        hosted: "Hosting w chmurze",
        hostedDescription: "Prześlij strony statyczne na 24-godzinny podgląd, dostępny także po wyłączeniu komputera wykonującego zadanie.",
        configure: "Skonfiguruj Cloudflare",
        unconfigured: "Nie skonfigurowano",
        unverified: "Skonfigurowano · oczekuje na weryfikację",
        verified: "Ostatnie sprawdzenie pomyślne",
        authorizationError: "Problem z autoryzacją · sprawdź token i uprawnienia",
        verificationUnavailable: "Nie można teraz zweryfikować",
        check: "Sprawdź połączenie",
        checking: "Sprawdzanie połączenia…",
        saveAndCheck: "Zapisz i sprawdź",
        tokenConnection: "Użyj Account ID i API Token; zapisane tokeny nie są wyświetlane.",
        enabledLabel: "Z dala od komputera: włączone",
        disabledLabel: "Z dala od komputera: wyłączone",
        publicationFailed: "Publikacja nie powiodła się; spróbuj ponownie lub sprawdź konfigurację",
        publicationAuthError: "Autoryzacja Cloudflare nie powiodła się. Zaktualizuj konfigurację.",
        retryPublication: "Poproś o ponowną publikację",
        useTunnelOnce: "Tym razem użyj tunelu tymczasowego",
        retryRequest: "Opublikuj ten podgląd ponownie w jego pierwotnym trybie.",
        tunnelOnceRequest: "Opublikuj ten podgląd ponownie przez tunel tymczasowy tylko tym razem. Nie zmieniaj moich ustawień globalnych.",
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'Wszystkie konta',
        codexUsageUnattributed: 'Nieprzypisane',
        codexUsageSelectAccount: 'Wybierz konto, aby zobaczyć pozostały limit.',
        codexUsageUnattributedHint: 'Lokalne sesje Codex bez jawnie wybranego konta Paws pozostają nieprzypisane.',
