...
export const pl: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Generuj teraz',
        imageEffectNeedsPhoto: 'Najpierw dodaj zdjęcie',
        imageEffectMachineOffline: 'Maszyna offline',
        imageEffectGenerating: 'Generowanie...',
        ...
        imageStylePhotoToStyledMotion: 'Style portretowe',
        imageStyleJapaneseCinemaFilm: 'Japoński film aktorski',
        imageStyleJapaneseCinemaFilmHint: 'Naturalny kolor taśmy 35 mm, miękkie światło zastane, realistyczna skóra i spokojny kadr obserwacyjny.',
        imageStyleHanddrawnAnimeFilm: 'Ręcznie rysowany film animowany',
        imageStyleHanddrawnAnimeFilmHint: 'Dopracowana kreska 2D, postacie malowane celami i fakturalne tło akwarelowo-gwaszowe.',
        imageStyle90sCelAnimation: 'Animacja cel z lat 90.',
        imageStyle90sCelAnimationHint: 'Ręcznie tuszowane kontury, dwustopniowy cel-shading, malowane tła i subtelne analogowe ziarno.',
        imageStyleSeinenMangaBw: 'Czarno-biała manga seinen',
        imageStyleSeinenMangaBwHint: 'Precyzyjna kreska mangi dla dorosłych, miękkie cienie, stabilne rastry i czysta skala szarości.',
        imageStyleCyberpunkGraphicNovel: 'Cyberpunkowa powieść graficzna',
        imageStyleCyberpunkGraphicNovelHint: 'Wyrazisty tusz, malarski cel-shading, selektywny raster i powściągliwe światło cyjan-magenta.',
        imageStyleAbstractScreenprintCollage: 'Abstrakcyjny kolaż sitodrukowy',
        imageStyleAbstractScreenprintCollageHint: 'Farba risograficzna, geometria wycinanego papieru, fakturalne przesunięcia i skupiona paleta pięciu barw.',
        imageStyleInkWashPortrait: 'Portret lawowany tuszem',
        imageStyleInkWashPortraitHint: 'Warstwowe pociągnięcia węglem, mineralnoszare lawowanie, faktura papieru i oszczędny cynobrowy akcent.',
        imageStyleVintageEditorialFilm: 'Vintage film redakcyjny',
        imageStyleVintageEditorialFilmHint: 'Autentyczny portret magazynowy z lat 70.–90., z wyczuwalnym ziarnem i zrównoważonym wyblakłym kolorem.',
        imageStyleCinematicRealism: 'Realizm filmowy',
        imageStyleCinematicRealismHint: 'Aktorski portret wierny tożsamości, z kontrolowanym światłem, dopracowanym kontrastem i filmowym kolorem.',
