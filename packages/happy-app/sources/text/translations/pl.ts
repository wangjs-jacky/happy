...
export const pl: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'Udostepnij w OpenBird',
        shareOpenBirdSubtitle: 'Opublikuj publiczny link migawki',
        shareOpenBirdConfirmTitle: 'Udostepnic sesje publicznie?',
        shareOpenBirdConfirmMessage: 'To opublikuje biezaca sesje w OpenBird jako publiczna strone internetowa. Kazdy z linkiem moze zobaczyc jej tresc.',
        shareOpenBirdPublish: 'Opublikuj',
        shareOpenBirdSuccess: 'Link OpenBird jest gotowy',
        shareOpenBirdNoMessages: 'Ta sesja nie ma jeszcze wiadomosci do udostepnienia.',
        shareOpenBirdLoadFailed: 'Nie mozna zaladowac pelnej sesji przed udostepnieniem.',
        shareOpenBirdFailed: 'Nie udalo sie udostepnic w OpenBird.',
