...
export const pl: TranslationStructure = {
    healthPanel: {
        ...
        welcomeRole: 'Dziennik zdrowia',
        welcomeSubtitle: 'Wyślij zrzut ekranu — zapiszę to.',
        welcomeSleep: 'Sen',
        welcomeExercise: 'Ćwiczenia',
        welcomeDiet: 'Dieta',
        welcomeHint: 'Raport snu, statystyki treningu, zdjęcia posiłków — odczytam i zapiszę liczby.',
        dormantTitle: 'Uśpiony',
        dormantHint: 'Wyślij zrzut, aby zacząć.',
    },
    composeHome: {
