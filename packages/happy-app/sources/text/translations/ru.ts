...
export const ru: TranslationStructure = {
    ...
    session: {
        ...
        forkErrorAmbiguousPoint: 'Это сообщение встречается несколько раз, поэтому точку ветвления пока нельзя определить однозначно. Повторите попытку после завершения синхронизации.',
