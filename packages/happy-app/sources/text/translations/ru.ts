...
export const ru: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Создать сейчас',
        imageEffectNeedsPhoto: 'Сначала добавьте фото',
        imageEffectMachineOffline: 'Машина не в сети',
        imageEffectGenerating: 'Создание...',
        ...
        imageStylePhotoToStyledMotion: 'Стили портрета',
        imageStyleJapaneseCinemaFilm: 'Японское игровое кино',
        imageStyleJapaneseCinemaFilmHint: 'Естественный цвет 35-мм плёнки, мягкий практический свет, реалистичная кожа и спокойная наблюдательная композиция.',
        imageStyleHanddrawnAnimeFilm: 'Рисованный анимационный фильм',
        imageStyleHanddrawnAnimeFilmHint: 'Точная 2D-линия, персонажи с целлулоидной заливкой и фактурный акварельно-гуашевый фон.',
        imageStyle90sCelAnimation: 'Целлулоидная анимация 90-х',
        imageStyle90sCelAnimationHint: 'Ручные тушевые контуры, двухступенчатые тени, рисованные фоны и мягкое аналоговое зерно.',
        imageStyleSeinenMangaBw: 'Чёрно-белая сэйнэн-манга',
        imageStyleSeinenMangaBwHint: 'Точная взрослая манга-линия, мягкие тени, стабильные скринтоны и чистая шкала серого.',
        imageStyleCyberpunkGraphicNovel: 'Киберпанк-графический роман',
        imageStyleCyberpunkGraphicNovelHint: 'Выразительная тушь, живописные цел-тени, выборочный растр и сдержанный цианово-пурпурный свет.',
        imageStyleAbstractScreenprintCollage: 'Абстрактный шелкографический коллаж',
        imageStyleAbstractScreenprintCollageHint: 'Ризографская краска, геометрия вырезанной бумаги, фактурное смещение и собранная палитра из пяти цветов.',
        imageStyleInkWashPortrait: 'Портрет тушевой размывкой',
        imageStyleInkWashPortraitHint: 'Слоистые угольные мазки, минерально-серые размывки, фактура бумаги и сдержанный киноварный акцент.',
        imageStyleVintageEditorialFilm: 'Винтажная журнальная плёнка',
        imageStyleVintageEditorialFilmHint: 'Аутентичный журнальный портрет 1970–90-х с осязаемым зерном и сбалансированным выцветшим цветом.',
        imageStyleCinematicRealism: 'Кинореализм',
        imageStyleCinematicRealismHint: 'Игровой портрет с сохранением личности, контролируемым светом, точным контрастом и кинематографичным цветом.',
