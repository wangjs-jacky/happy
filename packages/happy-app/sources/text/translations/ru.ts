...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'Поделиться через OpenBird',
        shareOpenBirdSubtitle: 'Опубликовать публичную ссылку-снимок',
        shareOpenBirdConfirmTitle: 'Поделиться сессией публично?',
        shareOpenBirdConfirmMessage: 'Текущая сессия будет опубликована в OpenBird как публичная веб-страница. Любой, у кого есть ссылка, сможет увидеть содержимое.',
        shareOpenBirdPublish: 'Опубликовать',
        shareOpenBirdSuccess: 'Ссылка OpenBird готова',
        shareOpenBirdNoMessages: 'В этой сессии пока нет сообщений для публикации.',
        shareOpenBirdLoadFailed: 'Не удалось загрузить полную сессию перед публикацией.',
        shareOpenBirdFailed: 'Не удалось поделиться через OpenBird.',
