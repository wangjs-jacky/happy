...
export const ru: TranslationStructure = {
    healthPanel: {
        ...
        welcomeRole: 'Дневник здоровья',
        welcomeSubtitle: 'Пришлите скриншот — я всё запишу.',
        welcomeSleep: 'Сон',
        welcomeExercise: 'Спорт',
        welcomeDiet: 'Питание',
        welcomeHint: 'Отчёт о сне, тренировки, фото еды — распознаю и сохраню цифры.',
        dormantTitle: 'Ожидание',
        dormantHint: 'Пришлите скриншот, чтобы начать.',
