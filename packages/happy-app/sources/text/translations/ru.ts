...
export const ru: TranslationStructure = {
    ...
    components: {
        ...
        messageComposer: {
            ...
            screenshotDisplayUnavailable: 'macOS не удалось создать изображение экрана. В Системных настройках > Конфиденциальность и безопасность > Запись экрана разрешите терминал или процесс Node, который запускает Happy, затем перезапустите этот сеанс. Если Mac заблокирован или дисплей спит, сначала разблокируйте или разбудите его.',
        },
        screenshotGallery: {
            title: 'Снимки экрана',
