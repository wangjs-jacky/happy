...
export const ru: TranslationStructure = {
    delivery: {
        tunnelMissing: "Чтобы открыть временный туннель, на рабочем компьютере нужно установить cloudflared.",
        hostingUnconfigured: "Облачный хостинг не настроен. Сначала настройте Cloudflare.",
        published: "Последняя публикация успешна",
        saved: "Настройки передачи результатов сохранены · действуют со следующего сообщения",
        updatedElsewhere: "Настройки передачи результатов изменены на другом устройстве",
        title: "Настройки передачи результатов",
        away: "Вдали от компьютера",
        description: "Предпочитать ссылки и вложения, доступные с телефона",
        scope: "Для всех сеансов с синхронизацией между устройствами",
        timing: "Действует со следующего сообщения; текущие задачи не затрагиваются",
        previewMode: "Режим веб-предпросмотра",
        tunnel: "Временный туннель",
        tunnelDescription: "Учётная запись Cloudflare не нужна. Рабочий компьютер и сеанс должны оставаться активными; до 24 часов.",
        hosted: "Облачный хостинг",
        hostedDescription: "Загрузка статических страниц для предпросмотра на 24 часа, доступного и после выключения рабочего компьютера.",
        configure: "Настроить Cloudflare",
        unconfigured: "Не настроено",
        unverified: "Настроено · ожидает проверки",
        verified: "Последняя проверка пройдена",
        authorizationError: "Ошибка авторизации · проверьте токен и права",
        verificationUnavailable: "Сейчас невозможно проверить",
        check: "Проверить соединение",
        checking: "Проверка соединения…",
        saveAndCheck: "Сохранить и проверить",
        tokenConnection: "Используйте Account ID и API Token; сохранённые токены не отображаются.",
        enabledLabel: "Вдали от компьютера: включено",
        disabledLabel: "Вдали от компьютера: выключено",
        publicationFailed: "Не удалось опубликовать; повторите попытку или проверьте настройки",
        publicationAuthError: "Ошибка авторизации Cloudflare. Обновите настройки.",
        retryPublication: "Запросить повторную публикацию",
        useTunnelOnce: "В этот раз использовать временный туннель",
        retryRequest: "Опубликуй этот предпросмотр повторно в его исходном режиме.",
        tunnelOnceRequest: "Опубликуй этот предпросмотр через временный туннель только в этот раз. Не меняй мои глобальные настройки.",
        checkedAt: ({ time }: { time: string }) => `Проверено: ${time}`,
    },
    accounts: {
        ...
        title: "Аккаунты Paws",
        description: "Смена аккаунта на этом устройстве. Другие вкладки браузера тоже переключатся.",
        empty: "Нет сохранённых аккаунтов",
        active: "Текущий аккаунт",
        switch: "Сменить аккаунт",
        remove: "Удалить с устройства",
        removeHint: "Удалить сохранённые данные входа? Сессии на сервере останутся.",
        add: "Добавить аккаунт",
        server: "URL сервера",
        label: "Название аккаунта (необязательно)",
        secret: "Ключ восстановления",
        secretHint: "Введите ключ восстановления добавляемого аккаунта. Добавление не переключает аккаунт автоматически.",
        target: "Открыть сессию",
        targetHint: "Проверьте аккаунт и сервер, затем выберите соответствующий аккаунт.",
        invalidLink: "Недействительная ссылка на аккаунт",
        failed: "Не удалось выполнить действие. Проверьте данные аккаунта и соединение и повторите попытку.",
        retry: "Повторить",
        restartRequired: "Требуется перезапуск",
        switching: "Переключение аккаунта…",
        restartHint: "Перезагрузите Paws, чтобы завершить переключение. Если это не помогает, закройте и снова откройте приложение.",
    },
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'Все аккаунты',
        codexUsageUnattributed: 'Без привязки',
        codexUsageSelectAccount: 'Выберите аккаунт, чтобы увидеть оставшуюся квоту.',
        codexUsageUnattributedHint: 'Локальные сеансы Codex без явно выбранного аккаунта Paws остаются без привязки.',
