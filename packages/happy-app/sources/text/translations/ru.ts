...
export const ru: TranslationStructure = {
    ...
    session: {
        ...
        continueBoundary: "Новая сессия",
        continueWaiting: "Ожидание вашего сообщения.",
        ...
        continueHistoryUnavailable: "Предыдущая сессия удалена или недоступна. Загрузить её историю невозможно.",
