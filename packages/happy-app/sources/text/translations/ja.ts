...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'OpenBirdで共有',
        shareOpenBirdSubtitle: '公開スナップショットリンクを発行',
        shareOpenBirdConfirmTitle: 'このセッションを公開共有しますか？',
        shareOpenBirdConfirmMessage: '現在のセッションをOpenBirdの公開Webページとして発行します。リンクを知っている人は内容を閲覧できます。',
        shareOpenBirdPublish: '公開',
        shareOpenBirdSuccess: 'OpenBirdリンクの準備ができました',
        shareOpenBirdNoMessages: 'このセッションには共有できるメッセージがまだありません。',
        shareOpenBirdLoadFailed: '共有前にセッション全体を読み込めませんでした。',
        shareOpenBirdFailed: 'OpenBirdへの共有に失敗しました。',
