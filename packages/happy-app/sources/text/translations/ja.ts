...
export const ja: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: '今すぐ生成',
        imageEffectNeedsPhoto: '先に写真を追加',
        imageEffectMachineOffline: '実行マシンはオフラインです',
        ...
        imageStylePhotoToStyledMotion: 'ポートレートスタイル',
        imageStyleJapaneseCinemaFilm: '日本実写映画',
        imageStyleJapaneseCinemaFilmHint: '自然な35mm映画色、柔らかな実景光、リアルな肌、静かな観察的構図。',
        imageStyleHanddrawnAnimeFilm: '手描きアニメーション映画',
        imageStyleHanddrawnAnimeFilmHint: '洗練された2D線画、セル彩色の人物、水彩とガッシュの質感ある背景。',
        imageStyle90sCelAnimation: '90年代セルアニメ',
        imageStyle90sCelAnimationHint: '手描きの輪郭、二段階のセル影、彩色背景、控えめなアナログ粒子。',
        imageStyleSeinenMangaBw: '白黒青年漫画',
        imageStyleSeinenMangaBwHint: '精密な青年漫画線、柔らかな影、安定したスクリーントーン、純粋なグレースケール。',
        imageStyleCyberpunkGraphicNovel: 'サイバーパンク・グラフィックノベル',
        imageStyleCyberpunkGraphicNovelHint: '力強い墨線、絵画的なセル影、選択的な網点、抑えたシアンとマゼンタの光。',
        imageStyleAbstractScreenprintCollage: '抽象シルクスクリーン・コラージュ',
        imageStyleAbstractScreenprintCollageHint: 'リソグラフのインク、切り紙の幾何形、版ずれの質感、絞り込んだ5色パレット。',
        imageStyleInkWashPortrait: '水墨ポートレート',
        imageStyleInkWashPortraitHint: '重なる炭墨の筆致、鉱物灰のにじみ、紙の質感、抑えた朱色の差し色。',
        imageStyleVintageEditorialFilm: 'ヴィンテージ編集写真',
        imageStyleVintageEditorialFilmHint: '1970〜90年代の雑誌らしい人物写真。手触りある粒子と均衡の取れた褪色色。',
        imageStyleCinematicRealism: 'シネマティック・リアリズム',
        imageStyleCinematicRealismHint: '人物らしさを守る実写ポートレート。制御された光、洗練されたコントラスト、映画的な色。',
