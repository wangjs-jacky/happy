...
export const zhHans: TranslationStructure = {
    ...
    devTools: {
        ...
        viewLogs: '查看日志',
        ota: 'OTA',
        otaFooter: '查看本机当前验收 OTA 版本，并切换锁定到某个 preview 历史版本（仅对本设备生效）。',
        otaVersionsSubtitle: '查看验收版本 / 切换并锁定 preview 历史版本',
        componentDemos: '组件演示',
        deviceInfo: '设备信息',
