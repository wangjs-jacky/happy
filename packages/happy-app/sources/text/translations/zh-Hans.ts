...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBirdLoadFailed: '分享前无法加载完整会话。',
        shareOpenBirdFailed: '分享到 OpenBird 失败。',
        shareHappy: '分享到 Happy Page',
        shareHappySubtitle: '发布 Happy 风格的公开页面',
        shareHappyConfirmTitle: '发布 Happy 分享页？',
        shareHappyConfirmMessage: '这会把当前会话发布为一个公开 Happy 页面。文字和图片附件都可能被包含；图片会上传为公开可访问的副本。任何拿到链接的人都可以查看或下载分享内容。',
        shareHappyPublish: '发布',
        shareHappySuccess: 'Happy 分享链接已生成',
        shareHappyFailed: '发布 Happy 分享页失败。',
        selectSession: '选择',
