...
export const zhHans: TranslationStructure = {
    ...
    agents: {
        ...
        scheduleManagerTitle: '日程管理专家',
        scheduleManagerPresetPlan: '生成今日作战图',
        scheduleManagerPresetReviewPool: '整理任务池',
        scheduleManagerPresetReset: '本周重置',
        scheduleDashboardTitle: '日程管理专家',
        scheduleDashboardBody: '左侧先读 TT，中心给判断，右侧只生成需要确认的执行指令。',
        scheduleStatusOnline: ({ machine }: { machine: string }) => `${machine} 可用`,
        scheduleStatusOffline: '请选择在线机器',
        scheduleOfflineHint: '当前可以先准备指令；真正发送需要一台在线机器。',
        scheduleContextRailTitle: '读取',
        schedulePlanLaneTitle: '判断',
        scheduleExecutionRailTitle: '执行',
        schedulePlanProtocolTitle: 'TT 协议',
        scheduleProtocolReadFirst: '先读 TT 事实',
        scheduleProtocolJudge: '区分必须做和可移动',
        scheduleProtocolConfirmFirst: '改 TT 前先确认',
        scheduleModuleTodayLabel: '今日',
        scheduleModuleTodayTitle: '今日作战图',
        scheduleModuleTodayBody: '区分必须今天做、可移动任务和需要你确认的事项。',
        scheduleModuleTodayMetric: 'TT 今日 + 已完成',
        scheduleModulePoolLabel: '任务池',
        scheduleModulePoolTitle: '任务池整理',
        scheduleModulePoolBody: '按项目、能量和缺失上下文给未定日期任务分组。',
        scheduleModulePoolMetric: '未定日期积压',
        scheduleModuleCalendarLabel: '时间块',
        scheduleModuleCalendarTitle: '时间块安排',
        scheduleModuleCalendarBody: '把下一步放进现实可执行的时间块，不把一天塞满。',
        scheduleModuleCalendarMetric: '确认后再排期',
        scheduleModuleReviewLabel: '复盘',
        scheduleModuleReviewTitle: '复盘闭环',
        scheduleModuleReviewBody: '用完成、逾期和放弃事项改进明天的安排。',
        scheduleModuleReviewMetric: '收口与迭代',
        scheduleActionsTitle: 'Agent 模块',
        scheduleOpenChat: 'Chat',
        scheduleActionPlanToday: '生成今日作战图',
        scheduleActionPlanTodayBody: '读取 TT 并草拟执行顺序。',
        scheduleActionReviewPool: '整理任务池',
        scheduleActionReviewPoolBody: '先选出值得排期的任务，再改 TT。',
        scheduleActionSyncTt: '同步 TT',
        scheduleActionSyncTtBody: '刷新今日、已完成、任务池和逾期状态。',
        scheduleActionWeeklyReset: '本周重置',
        scheduleActionWeeklyResetBody: '总结风险，提出更轻的周计划。',
        scheduleRunInChat: '写入 Chat',
        scheduleChatPanelTitle: 'Chat 交接区',
        schedulePromptReady: '指令已准备',
        schedulePromptEmpty: '暂无指令',
        scheduleChatPanelReady: ({ action }: { action: string }) => `${action} 已写入 Chat。检查后即可发送。`,
        scheduleChatPanelEmpty: '点击模块或快捷指令，先准备一条理解 TT 协议的 prompt，再在 Chat 里继续。',
        scheduleChatCollapsed: 'Chat 一直保留，用来补上下文或确认 TT 写操作。',
        machineOffline: '机器离线',
