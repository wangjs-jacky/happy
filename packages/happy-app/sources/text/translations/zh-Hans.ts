...
export const zhHans: TranslationStructure = {
    ...
    interactivePreviews: {
        title: '临时交互预览', provider: 'Vercel', connection: '连接状态', loading: '正在加载连接状态…',
        cloudflareProvider: 'Cloudflare',
        cloudflareDescription: '无需登录，在会话中让助手通过 Cloudflare 发布即可。运行会话的机器需安装 cloudflared。',
        sessionLifetime: '会话及其所在机器持续运行时有效，最长 24 小时。',
        unavailable: '此 Happy Server 暂不可用 Vercel 预览。', disconnected: '未连接',
        connected: ({ name }: { name: string }) => `已连接 ${name}`, project: '预览项目',
        connect: '连接 Vercel', reconnect: '重新连接 Vercel', disconnect: '断开 Vercel',
        disconnectTitle: '断开 Vercel？', disconnectBody: '新的 Vercel 预览将立即停止发布；系统会尽力删除已有的 Vercel 预览。',
        disconnectWarning: '部分已发布预览未能删除，请在 Vercel 中手动移除。',
        popupBlocked: '请允许 Happy 打开弹窗后再连接。', safeError: '无法更新临时预览，请重试。', retry: '重试',
        disclosure: '预览链接可公开访问，有效期取决于发布渠道：Vercel 预览将在 24 小时后安排删除；Cloudflare 预览在会话及其所在机器持续运行时有效，最长 24 小时。',
