...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareToOpenBird: '分享到 OpenBird',
        shareToOpenBirdEmpty: '该会话暂时没有可分享的消息。',
        shareToOpenBirdFailed: '分享到 OpenBird 失败。',
        shareToOpenBirdSuccess: '已分享到 OpenBird',
        shareToOpenBirdSuccessMessage: ({ url }: { url: string }) => `链接已复制到剪贴板：\n${url}`,
        shareToOpenBirdSubtitle: '把该会话发布成可分享的网页',
        shareToOpenBirdExistingTitle: '已分享过',
        shareToOpenBirdExistingMessage: ({ url }: { url: string }) => `该会话之前已分享过：\n${url}`,
        shareToOpenBirdCopyExisting: '复制已有链接',
        shareToOpenBirdRepublish: '重新发布',
        shareToOpenBirdCopiedMessage: ({ url }: { url: string }) => `链接已复制到剪贴板：\n${url}`,
        selectSession: '选择',
