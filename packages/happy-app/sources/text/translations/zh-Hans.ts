...
export const zhHans: TranslationStructure = {
    delivery: {
        tunnelMissing: "执行机器需要安装 cloudflared，才能开启临时隧道。",
        hostingUnconfigured: "尚未配置云端托管，请先配置 Cloudflare。",
        published: "最近发布成功",
        saved: "交付设置已保存 · 从下一条消息生效",
        updatedElsewhere: "交付设置已在其他设备更新",
        title: "交付设置",
        away: "离开电脑",
        description: "优先提供手机可打开的链接或聊天附件",
        scope: "全局生效 · 跨设备同步",
        timing: "从下一条消息生效，当前任务不受影响",
        previewMode: "网页预览方式",
        tunnel: "临时隧道",
        tunnelDescription: "无需 Cloudflare 账户。执行机器和会话需保持运行，最长 24 小时。",
        hosted: "云端托管",
        hostedDescription: "上传静态页面，执行机器关闭后仍可查看，保留 24 小时。",
        configure: "配置 Cloudflare",
        unconfigured: "未配置",
        unverified: "已配置 · 待验证",
        verified: "最近检查通过",
        authorizationError: "授权异常 · 检查 Token 与权限",
        verificationUnavailable: "暂时无法验证",
        check: "检查连接",
        checking: "正在检查连接…",
        saveAndCheck: "保存并检查",
        tokenConnection: "使用 Account ID 和 API Token；已保存的 Token 不会回显。",
        enabledLabel: "离开电脑：已开启",
        disabledLabel: "离开电脑：已关闭",
        publicationFailed: "发布失败，请重试或检查配置",
        publicationAuthError: "Cloudflare 授权检查失败，请更新配置。",
        retryPublication: "请求重新发布",
        useTunnelOnce: "本次改用临时隧道",
        retryRequest: "请按这个预览原来的方式重新发布。",
        tunnelOnceRequest: "请仅本次使用临时隧道重新发布这个预览，不修改全局偏好。",
        checkedAt: ({ time }: { time: string }) => `检查时间：${time}`,
    },
    accounts: {
    ...
    machine: {
        ...
        codexUsage: 'Codex 用量',
        codexUsageAllAccounts: '全部账号',
        codexUsageUnattributed: '未归属',
        codexUsageSelectAccount: '选择一个账号查看它的剩余额度。',
        codexUsageUnattributedHint: '未通过 Paws 明确选择账号的本机 Codex 会话保持为未归属。',
        codexUsageToday: '今天',
