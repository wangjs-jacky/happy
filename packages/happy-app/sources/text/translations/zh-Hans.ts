...
export const zhHans: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: '立即生成',
        imageEffectNeedsPhoto: '请先添加照片',
        imageEffectMachineOffline: '执行机离线',
        imageEffectGenerating: '生成中...',
        ...
        imageStylePhotoToStyledMotion: '照片风格化',
        imageStyleJapaneseCinemaFilm: '日系真人电影',
        imageStyleJapaneseCinemaFilmHint: '自然 35mm 电影色彩、柔和现场光、真实肤质与安静的观察式构图。',
        imageStyleHanddrawnAnimeFilm: '手绘动画电影',
        imageStyleHanddrawnAnimeFilmHint: '精致二维线稿、赛璐璐人物上色与有触感的水彩水粉场景。',
        imageStyle90sCelAnimation: '90年代赛璐璐',
        imageStyle90sCelAnimationHint: '手工勾线、两阶赛璐璐阴影、手绘背景与克制的模拟颗粒。',
        imageStyleSeinenMangaBw: '黑白青年漫画',
        imageStyleSeinenMangaBwHint: '精准成人漫画线条、羽化阴影、稳定网点与纯黑白灰层次。',
        imageStyleCyberpunkGraphicNovel: '赛博朋克绘本',
        imageStyleCyberpunkGraphicNovelHint: '醒目墨线、绘画式赛璐璐阴影、局部网点与克制的青品红光。',
        imageStyleAbstractScreenprintCollage: '抽象丝网拼贴',
        imageStyleAbstractScreenprintCollageHint: '孔版印刷墨色、剪纸几何、错版肌理与聚焦的五色调色板。',
        imageStyleInkWashPortrait: '水墨肖像',
        imageStyleInkWashPortraitHint: '层叠炭墨笔触、矿物灰晕染、纸张肌理与克制朱砂点色。',
        imageStyleVintageEditorialFilm: '复古杂志胶片',
        imageStyleVintageEditorialFilmHint: '真实 1970-90 年代杂志人像质感，带触感颗粒与平衡的褪色色彩。',
        imageStyleCinematicRealism: '电影写实',
        imageStyleCinematicRealismHint: '忠于人物身份的真人电影肖像，使用受控光线、精炼反差与电影色彩。',
