...
export const pt: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Gerar agora',
        imageEffectNeedsPhoto: 'Adicione uma foto primeiro',
        imageEffectMachineOffline: 'Máquina offline',
        imageEffectGenerating: 'Gerando...',
        ...
        imageStyleJapaneseCinemaFilm: 'Cinema japonês em imagem real',
        imageStyleJapaneseCinemaFilmHint: 'Cor cinematográfica natural de 35 mm, luz ambiente suave, pele realista e enquadramento observacional sereno.',
        imageStyleHanddrawnAnimeFilm: 'Filme de animação desenhado à mão',
        imageStyleHanddrawnAnimeFilmHint: 'Traço 2D refinado, personagens pintados em cel e cenário tátil em aquarela e guache.',
        imageStyle90sCelAnimation: 'Animação cel dos anos 90',
        imageStyle90sCelAnimationHint: 'Contornos com tinta manual, sombras cel em dois níveis, fundos pintados e grão analógico sutil.',
        imageStyleSeinenMangaBw: 'Mangá seinen em preto e branco',
        imageStyleSeinenMangaBwHint: 'Traço preciso de mangá adulto, sombras suaves, retículas estáveis e escala de cinza pura.',
        imageStyleCyberpunkGraphicNovel: 'Graphic novel cyberpunk',
        imageStyleCyberpunkGraphicNovelHint: 'Tinta marcante, sombras cel pictóricas, retícula seletiva e luz ciano-magenta contida.',
        imageStyleAbstractScreenprintCollage: 'Colagem serigráfica abstrata',
        imageStyleAbstractScreenprintCollageHint: 'Tinta risográfica, geometria de papel recortado, registro tátil e paleta focada em cinco cores.',
        imageStyleInkWashPortrait: 'Retrato em aguada de tinta',
        imageStyleInkWashPortraitHint: 'Pinceladas de carvão em camadas, aguadas cinza-mineral, textura de papel e acento cinábrio contido.',
        imageStyleVintageEditorialFilm: 'Filme editorial vintage',
        imageStyleVintageEditorialFilmHint: 'Retrato editorial autêntico dos anos 70-90, com grão tátil e cor desbotada equilibrada.',
        imageStyleCinematicRealism: 'Realismo cinematográfico',
        imageStyleCinematicRealismHint: 'Retrato em imagem real fiel à identidade, com luz controlada, contraste refinado e cor fílmica.',
