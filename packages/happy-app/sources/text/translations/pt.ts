...
export const pt: TranslationStructure = {
    healthPanel: {
        ...
        welcomeRole: 'Registro de saúde',
        welcomeSubtitle: 'Envie um print e eu registro pra você.',
        welcomeSleep: 'Sono',
        welcomeExercise: 'Exercício',
        welcomeDiet: 'Dieta',
        welcomeHint: 'Relatório de sono, dados de treino, fotos das refeições — eu leio e salvo os números.',
        dormantTitle: 'Em repouso',
        dormantHint: 'Envie um print para começar.',
    },
    composeHome: {
