...
export const pt: TranslationStructure = {
    delivery: {
        tunnelMissing: "A máquina de execução precisa ter o cloudflared instalado para abrir um túnel temporário.",
        hostingUnconfigured: "A hospedagem na nuvem não está configurada. Configure o Cloudflare primeiro.",
        published: "Última publicação concluída com sucesso",
        saved: "Preferência de entrega salva · aplica-se a partir da próxima mensagem",
        updatedElsewhere: "Preferência de entrega atualizada em outro dispositivo",
        title: "Configurações de entrega",
        away: "Longe do computador",
        description: "Priorizar links e anexos acessíveis pelo celular",
        scope: "Aplica-se a todas as sessões e sincroniza entre dispositivos",
        timing: "Aplica-se a partir da próxima mensagem; tarefas em andamento não são afetadas",
        previewMode: "Modo de prévia web",
        tunnel: "Túnel temporário",
        tunnelDescription: "Não exige conta Cloudflare. A máquina de execução e a sessão devem permanecer ativas; até 24 horas.",
        hosted: "Hospedagem na nuvem",
        hostedDescription: "Envie páginas estáticas para uma prévia de 24 horas, disponível mesmo após desligar a máquina de execução.",
        configure: "Configurar Cloudflare",
        unconfigured: "Não configurado",
        unverified: "Configurado · aguardando verificação",
        verified: "Última verificação concluída com sucesso",
        authorizationError: "Problema de autorização · confira o token e as permissões",
        verificationUnavailable: "Não foi possível verificar agora",
        check: "Verificar conexão",
        checking: "Verificando conexão…",
        saveAndCheck: "Salvar e verificar",
        tokenConnection: "Use Account ID e API Token; tokens salvos nunca são exibidos.",
        enabledLabel: "Longe do computador: ativado",
        disabledLabel: "Longe do computador: desativado",
        publicationFailed: "Falha ao publicar; tente novamente ou confira a configuração",
        publicationAuthError: "Falha na autorização do Cloudflare. Atualize a configuração.",
        retryPublication: "Solicitar publicação novamente",
        useTunnelOnce: "Usar túnel temporário desta vez",
        retryRequest: "Publique esta prévia novamente usando o modo original.",
        tunnelOnceRequest: "Publique esta prévia novamente usando um túnel temporário apenas desta vez. Não altere minha preferência global.",
    ...
    accounts: {
        ...
        title: "Contas Paws",
        description: "Troque de conta neste dispositivo. As outras abas do navegador também mudarão.",
        empty: "Nenhuma conta salva",
        active: "Conta atual",
        switch: "Trocar de conta",
        remove: "Remover do dispositivo",
        removeHint: "Remover este acesso salvo? As sessões no servidor serão mantidas.",
        add: "Adicionar conta",
        server: "URL do servidor",
        label: "Nome da conta (opcional)",
        secret: "Chave de recuperação",
        secretHint: "Insira a chave de recuperação da conta a adicionar. A conta não será trocada automaticamente.",
        target: "Abrir sessão",
        targetHint: "Confira a conta e o servidor e selecione a conta correspondente.",
        invalidLink: "Link de conta inválido",
        failed: "Não foi possível concluir a ação. Confira os dados da conta e a conexão e tente novamente.",
        retry: "Tentar novamente",
        restartRequired: "É necessário reiniciar",
        switching: "Trocando de conta…",
        restartHint: "Recarregue o Paws para concluir a troca. Se não funcionar, feche e abra o aplicativo novamente.",
    },
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'Todas as contas',
        codexUsageUnattributed: 'Sem atribuição',
        codexUsageSelectAccount: 'Selecione uma conta para ver a cota restante.',
        codexUsageUnattributedHint: 'As sessões locais do Codex sem uma conta Paws explícita permanecem sem atribuição.',
