...
export const pt: TranslationStructure = {
    ...
    desktopWorkspace: {
        ...
        pinSessions: 'Fixar a barra lateral de sessões',
        unpinSessions: 'Desafixar a barra lateral de sessões',
    ...
    session: {
        ...
        continueBoundary: "Nova sessão",
        continueWaiting: "Aguardando sua mensagem.",
        ...
        continueHistoryUnavailable: "A sessão anterior foi excluída ou não está mais disponível. Não é possível carregar seu histórico.",
