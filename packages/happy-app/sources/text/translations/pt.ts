...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'Compartilhar com OpenBird',
        shareOpenBirdSubtitle: 'Publicar um link de snapshot publico',
        shareOpenBirdConfirmTitle: 'Compartilhar sessao publicamente?',
        shareOpenBirdConfirmMessage: 'Isso publica a sessao atual no OpenBird como uma pagina web publica. Qualquer pessoa com o link pode ver o conteudo.',
        shareOpenBirdPublish: 'Publicar',
        shareOpenBirdSuccess: 'Link do OpenBird pronto',
        shareOpenBirdNoMessages: 'Esta sessao ainda nao tem mensagens para compartilhar.',
        shareOpenBirdLoadFailed: 'Nao foi possivel carregar a sessao completa antes de compartilhar.',
        shareOpenBirdFailed: 'Falha ao compartilhar com OpenBird.',
