...
export const it: TranslationStructure = {
    ...
    session: {
        ...
        continueBoundary: "Nuova sessione",
        continueWaiting: "In attesa del tuo messaggio.",
        ...
        continueHistoryUnavailable: "La sessione precedente è stata eliminata o non è più disponibile. Impossibile caricarne la cronologia.",
