...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'Condividi con OpenBird',
        shareOpenBirdSubtitle: 'Pubblica un link snapshot pubblico',
        shareOpenBirdConfirmTitle: 'Condividere pubblicamente la sessione?',
        shareOpenBirdConfirmMessage: 'Questo pubblica la sessione corrente su OpenBird come pagina web pubblica. Chiunque abbia il link puo vedere il contenuto.',
        shareOpenBirdPublish: 'Pubblica',
        shareOpenBirdSuccess: 'Link OpenBird pronto',
        shareOpenBirdNoMessages: 'Questa sessione non ha ancora messaggi da condividere.',
        shareOpenBirdLoadFailed: 'Impossibile caricare la sessione completa prima della condivisione.',
        shareOpenBirdFailed: 'Condivisione con OpenBird non riuscita.',
