...
export const it: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Genera ora',
        imageEffectNeedsPhoto: 'Aggiungi prima una foto',
        imageEffectMachineOffline: 'Macchina offline',
        imageEffectGenerating: 'Generazione in corso...',
        ...
        imageStylePhotoToStyledMotion: 'Stili ritratto',
        imageStyleJapaneseCinemaFilm: 'Cinema giapponese live action',
        imageStyleJapaneseCinemaFilmHint: 'Colore cinematografico naturale 35 mm, luce ambiente morbida, pelle realistica e inquadratura osservativa discreta.',
        imageStyleHanddrawnAnimeFilm: 'Film d\'animazione disegnato a mano',
        imageStyleHanddrawnAnimeFilmHint: 'Tratto 2D raffinato, personaggi colorati su cel e ambienti materici ad acquerello e gouache.',
        imageStyle90sCelAnimation: 'Animazione cel anni \'90',
        imageStyle90sCelAnimationHint: 'Contorni inchiostrati a mano, ombre cel a due livelli, fondali dipinti e grana analogica sottile.',
        imageStyleSeinenMangaBw: 'Manga seinen in bianco e nero',
        imageStyleSeinenMangaBwHint: 'Tratto preciso da manga adulto, ombre sfumate, retini stabili e scala di grigi pura.',
        imageStyleCyberpunkGraphicNovel: 'Graphic novel cyberpunk',
        imageStyleCyberpunkGraphicNovelHint: 'Inchiostro deciso, ombre cel pittoriche, retino selettivo e luce ciano-magenta controllata.',
        imageStyleAbstractScreenprintCollage: 'Collage serigrafico astratto',
        imageStyleAbstractScreenprintCollageHint: 'Inchiostro risograph, geometrie di carta ritagliata, registro materico e palette mirata a cinque colori.',
        imageStyleInkWashPortrait: 'Ritratto a inchiostro diluito',
        imageStyleInkWashPortraitHint: 'Pennellate stratificate a carboncino, velature grigio minerale, texture di carta e un accento cinabro discreto.',
        imageStyleVintageEditorialFilm: 'Pellicola editoriale vintage',
        imageStyleVintageEditorialFilmHint: 'Ritratto editoriale autentico anni \'70-\'90, con grana materica e colori sbiaditi ma equilibrati.',
        imageStyleCinematicRealism: 'Realismo cinematografico',
        imageStyleCinematicRealismHint: 'Ritratto live action fedele all\'identità, con luce controllata, contrasto raffinato e colore filmico.',
