...
export const it: TranslationStructure = {
    delivery: {
        tunnelMissing: "Per aprire un tunnel temporaneo, sul computer di esecuzione deve essere installato cloudflared.",
        hostingUnconfigured: "L’hosting cloud non è configurato. Configura prima Cloudflare.",
        published: "Ultima pubblicazione riuscita",
        saved: "Preferenza di consegna salvata · si applica dal prossimo messaggio",
        updatedElsewhere: "Preferenza di consegna aggiornata su un altro dispositivo",
        title: "Impostazioni di consegna",
        away: "Lontano dal computer",
        description: "Preferisci link e allegati accessibili dal telefono",
        scope: "Si applica a tutte le sessioni e si sincronizza tra dispositivi",
        timing: "Si applica dal prossimo messaggio; le attività in corso non cambiano",
        previewMode: "Modalità anteprima web",
        tunnel: "Tunnel temporaneo",
        tunnelDescription: "Nessun account Cloudflare richiesto. Il computer di esecuzione e la sessione devono restare attivi; fino a 24 ore.",
        hosted: "Hosting cloud",
        hostedDescription: "Carica pagine statiche per un’anteprima di 24 ore, disponibile anche dopo lo spegnimento del computer di esecuzione.",
        configure: "Configura Cloudflare",
        unconfigured: "Non configurato",
        unverified: "Configurato · in attesa di verifica",
        verified: "Ultima verifica riuscita",
        authorizationError: "Problema di autorizzazione · controlla token e permessi",
        verificationUnavailable: "Impossibile verificare al momento",
        check: "Verifica connessione",
        checking: "Verifica della connessione…",
        saveAndCheck: "Salva e verifica",
        tokenConnection: "Usa Account ID e API Token; i token salvati non vengono mai mostrati.",
        enabledLabel: "Lontano dal computer: attivo",
        disabledLabel: "Lontano dal computer: disattivo",
        publicationFailed: "Pubblicazione non riuscita; riprova o controlla la configurazione",
        publicationAuthError: "Autorizzazione Cloudflare non riuscita. Aggiorna la configurazione.",
        retryPublication: "Richiedi una nuova pubblicazione",
        useTunnelOnce: "Usa un tunnel temporaneo questa volta",
        retryRequest: "Ripubblica questa anteprima usando la modalità originale.",
        tunnelOnceRequest: "Ripubblica questa anteprima usando un tunnel temporaneo solo questa volta. Non modificare la mia preferenza globale.",
        checkedAt: ({ time }: { time: string }) => `Verificato: ${time}`,
    },
    accounts: {
        attachmentWarning: "Il cambio di account ricaricherà Paws. Le bozze di testo verranno conservate, ma gli allegati non inviati dovranno essere selezionati di nuovo. Continuare?",
        title: "Account Paws",
        description: "Cambia account su questo dispositivo. Cambieranno anche le altre schede del browser.",
        empty: "Nessun account salvato",
        active: "Account attuale",
        switch: "Cambia account",
        remove: "Rimuovi dal dispositivo",
        removeHint: "Rimuovere questo accesso salvato? Le sessioni sul server verranno conservate.",
        add: "Aggiungi account",
        server: "URL del server",
        label: "Nome account (facoltativo)",
        secret: "Chiave di recupero",
        secretHint: "Inserisci la chiave di recupero dell’account da aggiungere. L’account non verrà cambiato automaticamente.",
        target: "Apri sessione",
        targetHint: "Controlla account e server, poi seleziona l’account corrispondente.",
        invalidLink: "Link dell’account non valido",
        failed: "Impossibile completare l’azione. Controlla i dati dell’account e la connessione, poi riprova.",
        retry: "Riprova",
        restartRequired: "Riavvio necessario",
        switching: "Cambio account…",
        restartHint: "Ricarica Paws per completare il cambio. Se non funziona, chiudi e riapri l’app.",
    },
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'Tutti gli account',
        codexUsageUnattributed: 'Non attribuito',
        codexUsageSelectAccount: 'Seleziona un account per vedere la quota rimanente.',
        codexUsageUnattributedHint: 'Le sessioni Codex locali senza un account Paws esplicito restano non attribuite.',
