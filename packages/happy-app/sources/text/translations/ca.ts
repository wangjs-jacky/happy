...
export const ca: TranslationStructure = {
    ...
    desktopWorkspace: {
        ...
        pinSessions: 'Fixa la barra lateral de sessions',
        unpinSessions: 'Desfixa la barra lateral de sessions',
    ...
    session: {
        ...
        continueBoundary: "Sessió nova",
        continueWaiting: "Esperant el teu missatge.",
        ...
        continueHistoryUnavailable: "La sessió anterior s’ha eliminat o ja no està disponible. No se’n pot carregar l’historial.",
