...
export const ca: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Genera ara',
        imageEffectNeedsPhoto: 'Afegeix una foto primer',
        imageEffectMachineOffline: 'Màquina fora de línia',
        imageEffectGenerating: 'S\'està generant...',
        ...
        imageStylePhotoToStyledMotion: 'Estils de retrat',
        imageStyleJapaneseCinemaFilm: 'Cinema japonès d\'imatge real',
        imageStyleJapaneseCinemaFilmHint: 'Color cinematogràfic natural de 35 mm, llum ambient suau, pell realista i enquadrament observacional serè.',
        imageStyleHanddrawnAnimeFilm: 'Pel·lícula animada dibuixada a mà',
        imageStyleHanddrawnAnimeFilmHint: 'Línia 2D refinada, personatges pintats en cel i escenaris tàctils d\'aquarel·la i guaix.',
        imageStyle90sCelAnimation: 'Animació cel dels anys 90',
        imageStyle90sCelAnimationHint: 'Contorns entintats a mà, ombrejat cel en dos passos, fons pintats i gra analògic subtil.',
        imageStyleSeinenMangaBw: 'Manga seinen en blanc i negre',
        imageStyleSeinenMangaBwHint: 'Línia precisa de manga adult, ombres suaus, trames estables i escala de grisos pura.',
        imageStyleCyberpunkGraphicNovel: 'Novel·la gràfica cyberpunk',
        imageStyleCyberpunkGraphicNovelHint: 'Tinta marcada, ombrejat cel pictòric, trama selectiva i llum cian-magenta continguda.',
        imageStyleAbstractScreenprintCollage: 'Collage serigràfic abstracte',
        imageStyleAbstractScreenprintCollageHint: 'Tinta risogràfica, geometria de paper retallat, registre tàctil i paleta enfocada de cinc colors.',
        imageStyleInkWashPortrait: 'Retrat amb aiguada de tinta',
        imageStyleInkWashPortraitHint: 'Pinzellades de carbó en capes, aiguades gris mineral, textura de paper i un accent cinabri contingut.',
        imageStyleVintageEditorialFilm: 'Pel·lícula editorial vintage',
        imageStyleVintageEditorialFilmHint: 'Retrat editorial autèntic dels anys 70-90, amb gra tàctil i color esvaït equilibrat.',
        imageStyleCinematicRealism: 'Realisme cinematogràfic',
        imageStyleCinematicRealismHint: 'Retrat d\'imatge real fidel a la identitat, amb llum controlada, contrast refinat i color fílmic.',
