...
export const ca: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'Comparteix amb OpenBird',
        shareOpenBirdSubtitle: 'Publica un enllac de snapshot public',
        shareOpenBirdConfirmTitle: 'Vols compartir la sessio publicament?',
        shareOpenBirdConfirmMessage: 'Aixo publica la sessio actual a OpenBird com una pagina web publica. Qualsevol persona amb l enllac pot veure el contingut.',
        shareOpenBirdPublish: 'Publica',
        shareOpenBirdSuccess: 'Enllac d OpenBird preparat',
        shareOpenBirdNoMessages: 'Aquesta sessio encara no te missatges per compartir.',
        shareOpenBirdLoadFailed: 'No s ha pogut carregar la sessio completa abans de compartir.',
        shareOpenBirdFailed: 'No s ha pogut compartir amb OpenBird.',
