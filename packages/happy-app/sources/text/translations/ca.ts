...
export const ca: TranslationStructure = {
    delivery: {
        tunnelMissing: "L’equip d’execució necessita tenir cloudflared instal·lat per obrir un túnel temporal.",
        hostingUnconfigured: "L’allotjament al núvol no està configurat. Configura Cloudflare primer.",
        published: "Última publicació correcta",
        saved: "Preferència de lliurament desada · s’aplica des del proper missatge",
        updatedElsewhere: "Preferència de lliurament actualitzada en un altre dispositiu",
        title: "Configuració del lliurament",
        away: "Lluny de l’ordinador",
        description: "Prioritza enllaços i fitxers adjunts accessibles des del mòbil",
        scope: "S’aplica a totes les sessions i se sincronitza entre dispositius",
        timing: "S’aplica des del proper missatge; no afecta les tasques en curs",
        previewMode: "Mode de previsualització web",
        tunnel: "Túnel temporal",
        tunnelDescription: "No cal un compte de Cloudflare. L’equip d’execució i la sessió han de continuar actius; fins a 24 hores.",
        hosted: "Allotjament al núvol",
        hostedDescription: "Puja pàgines estàtiques per a una previsualització de 24 hores, disponible després d’apagar l’equip d’execució.",
        configure: "Configura Cloudflare",
        unconfigured: "Sense configurar",
        unverified: "Configurat · pendent de verificació",
        verified: "Última comprovació correcta",
        authorizationError: "Problema d’autorització · comprova el token i els permisos",
        verificationUnavailable: "Ara no es pot verificar",
        check: "Comprova la connexió",
        checking: "S’està comprovant la connexió…",
        saveAndCheck: "Desa i comprova",
        tokenConnection: "Utilitza Account ID i API Token; els tokens desats no es mostren mai.",
        enabledLabel: "Lluny de l’ordinador: activat",
        disabledLabel: "Lluny de l’ordinador: desactivat",
        publicationFailed: "Error en publicar; torna-ho a provar o revisa la configuració",
        publicationAuthError: "Error d’autorització de Cloudflare. Actualitza la configuració.",
        retryPublication: "Sol·licita la publicació de nou",
        useTunnelOnce: "Utilitza un túnel temporal aquest cop",
        retryRequest: "Torna a publicar aquesta previsualització amb el seu mode original.",
        tunnelOnceRequest: "Torna a publicar aquesta previsualització amb un túnel temporal només aquest cop. No canviïs la meva preferència global.",
        checkedAt: ({ time }: { time: string }) => `Comprovat: ${time}`,
    },
    accounts: {
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'Tots els comptes',
        codexUsageUnattributed: 'Sense atribuir',
        codexUsageSelectAccount: 'Selecciona un compte per veure la quota restant.',
        codexUsageUnattributedHint: 'Les sessions locals de Codex sense un compte Paws explícit romanen sense atribuir.',
