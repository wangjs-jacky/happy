...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBird: 'Compartir con OpenBird',
        shareOpenBirdSubtitle: 'Publicar un enlace de instantanea publica',
        shareOpenBirdConfirmTitle: 'Compartir sesion publicamente?',
        shareOpenBirdConfirmMessage: 'Esto publica la sesion actual en OpenBird como una pagina web publica. Cualquiera con el enlace puede ver el contenido.',
        shareOpenBirdPublish: 'Publicar',
        shareOpenBirdSuccess: 'Enlace de OpenBird listo',
        shareOpenBirdNoMessages: 'Esta sesion aun no tiene mensajes para compartir.',
        shareOpenBirdLoadFailed: 'No se pudo cargar la sesion completa antes de compartir.',
        shareOpenBirdFailed: 'Error al compartir con OpenBird.',
