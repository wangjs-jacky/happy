...
export const es: TranslationStructure = {
    healthPanel: {
        ...
        welcomeRole: 'Registro de salud',
        welcomeSubtitle: 'Envía una captura y la registro por ti.',
        welcomeSleep: 'Sueño',
        welcomeExercise: 'Ejercicio',
        welcomeDiet: 'Dieta',
        welcomeHint: 'Informe de sueño, datos de ejercicio, fotos de comidas: los leo y guardo las cifras.',
        dormantTitle: 'En reposo',
        dormantHint: 'Envía una captura para empezar.',
    },
    composeHome: {
