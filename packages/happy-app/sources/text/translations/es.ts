...
export const es: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectGenerateNow: 'Generar ahora',
        imageEffectNeedsPhoto: 'Añade primero una foto',
        imageEffectMachineOffline: 'Máquina sin conexión',
        imageEffectGenerating: 'Generando...',
        ...
        imageStylePhotoToStyledMotion: 'Estilos de retrato',
        imageStyleJapaneseCinemaFilm: 'Cine japonés de imagen real',
        imageStyleJapaneseCinemaFilmHint: 'Color cinematográfico natural de 35 mm, luz ambiente suave, piel realista y encuadre observacional sereno.',
        imageStyleHanddrawnAnimeFilm: 'Película animada dibujada a mano',
        imageStyleHanddrawnAnimeFilmHint: 'Línea 2D refinada, personajes pintados en cel y escenarios táctiles de acuarela y gouache.',
        imageStyle90sCelAnimation: 'Animación cel de los 90',
        imageStyle90sCelAnimationHint: 'Contornos entintados a mano, sombreado cel en dos pasos, fondos pintados y grano analógico sutil.',
        imageStyleSeinenMangaBw: 'Manga seinen en blanco y negro',
        imageStyleSeinenMangaBwHint: 'Línea precisa de manga adulto, sombras suaves, tramas estables y escala de grises pura.',
        imageStyleCyberpunkGraphicNovel: 'Novela gráfica cyberpunk',
        imageStyleCyberpunkGraphicNovelHint: 'Tinta marcada, sombreado cel pictórico, trama selectiva y luz cian-magenta contenida.',
        imageStyleAbstractScreenprintCollage: 'Collage abstracto de serigrafía',
        imageStyleAbstractScreenprintCollageHint: 'Tinta risográfica, geometría de papel recortado, registro táctil y una paleta enfocada de cinco colores.',
        imageStyleInkWashPortrait: 'Retrato con tinta aguada',
        imageStyleInkWashPortraitHint: 'Pinceladas de carbón en capas, aguadas gris mineral, textura de papel y un acento cinabrio contenido.',
        imageStyleVintageEditorialFilm: 'Película editorial vintage',
        imageStyleVintageEditorialFilmHint: 'Retrato editorial auténtico de los años 70-90, con grano táctil y color desvaído equilibrado.',
        imageStyleCinematicRealism: 'Realismo cinematográfico',
        imageStyleCinematicRealismHint: 'Retrato de imagen real fiel a la identidad, con luz controlada, contraste refinado y color fílmico.',
