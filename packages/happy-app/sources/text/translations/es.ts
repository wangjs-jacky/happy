...
export const es: TranslationStructure = {
    ...
    desktopWorkspace: {
        ...
        pinSessions: 'Fijar la barra lateral de sesiones',
        unpinSessions: 'Desfijar la barra lateral de sesiones',
    ...
    session: {
        ...
        continueBoundary: "Nueva sesión",
        continueWaiting: "Esperando tu mensaje.",
        ...
        continueHistoryUnavailable: "La sesión anterior se ha eliminado o ya no está disponible. No se puede cargar su historial.",
