...
export const es: TranslationStructure = {
    delivery: {
        tunnelMissing: "El equipo de ejecución necesita tener cloudflared instalado para abrir un túnel temporal.",
        hostingUnconfigured: "El alojamiento en la nube no está configurado. Configura Cloudflare primero.",
        published: "Última publicación correcta",
        saved: "Preferencia de entrega guardada · se aplica desde tu próximo mensaje",
        updatedElsewhere: "Preferencia de entrega actualizada en otro dispositivo",
        title: "Ajustes de entrega",
        away: "Lejos del ordenador",
        description: "Priorizar enlaces y adjuntos accesibles desde el móvil",
        scope: "Se aplica a todas las sesiones y se sincroniza entre dispositivos",
        timing: "Se aplica desde tu próximo mensaje; no afecta a las tareas en curso",
        previewMode: "Modo de vista previa web",
        tunnel: "Túnel temporal",
        tunnelDescription: "Sin cuenta de Cloudflare. El equipo de ejecución y la sesión deben seguir activos; hasta 24 horas.",
        hosted: "Alojamiento en la nube",
        hostedDescription: "Sube páginas estáticas para una vista previa de 24 horas, disponible incluso al apagar el equipo de ejecución.",
        configure: "Configurar Cloudflare",
        unconfigured: "Sin configurar",
        unverified: "Configurado · pendiente de verificación",
        verified: "Última comprobación correcta",
        authorizationError: "Problema de autorización · revisa el token y los permisos",
        verificationUnavailable: "No se puede verificar ahora",
        check: "Comprobar conexión",
        checking: "Comprobando conexión…",
        saveAndCheck: "Guardar y comprobar",
        tokenConnection: "Usa Account ID y API Token; los tokens guardados nunca se muestran.",
        enabledLabel: "Lejos del ordenador: activado",
        disabledLabel: "Lejos del ordenador: desactivado",
        publicationFailed: "Error al publicar; reintenta o revisa la configuración",
        publicationAuthError: "Error de autorización de Cloudflare. Actualiza la configuración.",
        retryPublication: "Solicitar publicación de nuevo",
        useTunnelOnce: "Usar túnel temporal esta vez",
        retryRequest: "Vuelve a publicar esta vista previa usando su modo original.",
        tunnelOnceRequest: "Vuelve a publicar esta vista previa usando un túnel temporal solo esta vez. No cambies mi preferencia global.",
    ...
    machine: {
        ...
        codexUsageAllAccounts: 'Todas las cuentas',
        codexUsageUnattributed: 'Sin atribuir',
        codexUsageSelectAccount: 'Selecciona una cuenta para ver su cuota restante.',
        codexUsageUnattributedHint: 'Las sesiones locales de Codex sin una cuenta de Paws explícita permanecen sin atribuir.',
        codexUsageToday: 'Hoy',
