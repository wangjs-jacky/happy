...
export const zhHant: TranslationStructure = {
    delivery: {
        tunnelMissing: "執行機器需要安裝 cloudflared，才能開啟臨時通道。",
        hostingUnconfigured: "尚未設定雲端託管，請先設定 Cloudflare。",
        published: "最近發佈成功",
        saved: "交付設定已儲存 · 從下一則訊息生效",
        updatedElsewhere: "交付設定已在其他裝置更新",
        title: "交付設定",
        away: "離開電腦",
        description: "優先提供手機可開啟的連結或聊天附件",
        scope: "全域生效 · 跨裝置同步",
        timing: "從下一則訊息生效，目前任務不受影響",
        previewMode: "網頁預覽方式",
        tunnel: "臨時通道",
        tunnelDescription: "無需 Cloudflare 帳戶。執行機器和工作階段需保持運作，最長 24 小時。",
        hosted: "雲端託管",
        hostedDescription: "上傳靜態頁面，執行機器關閉後仍可查看，保留 24 小時。",
        configure: "設定 Cloudflare",
        unconfigured: "未設定",
        unverified: "已設定 · 待驗證",
        verified: "最近檢查通過",
        authorizationError: "授權異常 · 檢查 Token 與權限",
        verificationUnavailable: "暫時無法驗證",
        check: "檢查連線",
        checking: "正在檢查連線…",
        saveAndCheck: "儲存並檢查",
        tokenConnection: "使用 Account ID 和 API Token；已儲存的 Token 不會回顯。",
        enabledLabel: "離開電腦：已開啟",
        disabledLabel: "離開電腦：已關閉",
        publicationFailed: "發佈失敗，請重試或檢查設定",
        publicationAuthError: "Cloudflare 授權檢查失敗，請更新設定。",
        retryPublication: "請求重新發佈",
        useTunnelOnce: "本次改用臨時通道",
        retryRequest: "請依這個預覽原本的方式重新發佈。",
        tunnelOnceRequest: "請僅本次使用臨時通道重新發佈這個預覽，不修改全域偏好。",
        checkedAt: ({ time }: { time: string }) => `檢查時間：${time}`,
    },
    accounts: {
    ...
    machine: {
        ...
        codexUsage: 'Codex 用量',
        codexUsageAllAccounts: '全部帳號',
        codexUsageUnattributed: '未歸屬',
        codexUsageSelectAccount: '選擇一個帳號查看其剩餘額度。',
        codexUsageUnattributedHint: '未透過 Paws 明確選擇帳號的本機 Codex 會話保持為未歸屬。',
        codexUsageToday: '今天',
