...
export const zhHant: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareOpenBirdLoadFailed: '分享前無法載入完整工作階段。',
        shareOpenBirdFailed: '分享到 OpenBird 失敗。',
        shareHappy: '分享到 Happy Page',
        shareHappySubtitle: '發布 Happy 風格的公開頁面',
        shareHappyConfirmTitle: '發布 Happy 分享頁？',
        shareHappyConfirmMessage: '這會把目前工作階段發布為一個公開 Happy 頁面。文字和圖片附件都可能被包含；圖片會上傳為公開可存取的副本。任何拿到連結的人都可以查看或下載分享內容。',
        shareHappyPublish: '發布',
        shareHappySuccess: 'Happy 分享連結已產生',
        shareHappyFailed: '發布 Happy 分享頁失敗。',
        selectSession: '選擇',
