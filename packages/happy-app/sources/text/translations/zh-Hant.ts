...
export const zhHant: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        shareToOpenBirdEmpty: '此工作階段暫時沒有可分享的訊息。',
        shareToOpenBirdFailed: '分享到 OpenBird 失敗。',
        shareToOpenBirdSuccess: '已分享到 OpenBird',
        shareToOpenBirdSuccessMessage: ({ url }: { url: string }) => `連結已複製到剪貼簿：\n${url}`,
        shareToOpenBirdSubtitle: '把此工作階段發佈成可分享的網頁',
        shareToOpenBirdExistingTitle: '已分享過',
        shareToOpenBirdExistingMessage: ({ url }: { url: string }) => `此工作階段之前已分享過：\n${url}`,
        shareToOpenBirdCopyExisting: '複製既有連結',
        shareToOpenBirdRepublish: '重新發佈',
        shareToOpenBirdCopiedMessage: ({ url }: { url: string }) => `連結已複製到剪貼簿：\n${url}`,
        selectSession: '選擇',
