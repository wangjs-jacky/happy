...
export const zhHant: TranslationStructure = {
    ...
    agents: {
        ...
        scheduleManagerTitle: '日程管理專家',
        scheduleManagerPresetPlan: '生成今日作戰圖',
        scheduleManagerPresetReviewPool: '整理任務池',
        scheduleManagerPresetReset: '本週重置',
        scheduleDashboardTitle: '日程管理專家',
        scheduleDashboardBody: '左側先讀 TT，中心給判斷，右側只生成需要確認的執行指令。',
        scheduleStatusOnline: ({ machine }: { machine: string }) => `${machine} 可用`,
        scheduleStatusOffline: '請選擇在線機器',
        scheduleOfflineHint: '目前可以先準備指令；真正送出需要一台在線機器。',
        scheduleContextRailTitle: '讀取',
        schedulePlanLaneTitle: '判斷',
        scheduleExecutionRailTitle: '執行',
        schedulePlanProtocolTitle: 'TT 協議',
        scheduleProtocolReadFirst: '先讀 TT 事實',
        scheduleProtocolJudge: '區分必須做和可移動',
        scheduleProtocolConfirmFirst: '改 TT 前先確認',
        scheduleModuleTodayLabel: '今日',
        scheduleModuleTodayTitle: '今日作戰圖',
        scheduleModuleTodayBody: '區分必須今天做、可移動任務和需要你確認的事項。',
        scheduleModuleTodayMetric: 'TT 今日 + 已完成',
        scheduleModulePoolLabel: '任務池',
        scheduleModulePoolTitle: '任務池整理',
        scheduleModulePoolBody: '按專案、能量和缺失上下文給未定日期任務分組。',
        scheduleModulePoolMetric: '未定日期積壓',
        scheduleModuleCalendarLabel: '時間塊',
        scheduleModuleCalendarTitle: '時間塊安排',
        scheduleModuleCalendarBody: '把下一步放進現實可執行的時間塊，不把一天塞滿。',
        scheduleModuleCalendarMetric: '確認後再排期',
        scheduleModuleReviewLabel: '復盤',
        scheduleModuleReviewTitle: '復盤閉環',
        scheduleModuleReviewBody: '用完成、逾期和放棄事項改進明天的安排。',
        scheduleModuleReviewMetric: '收口與迭代',
        scheduleActionsTitle: 'Agent 模組',
        scheduleOpenChat: 'Chat',
        scheduleActionPlanToday: '生成今日作戰圖',
        scheduleActionPlanTodayBody: '讀取 TT 並草擬執行順序。',
        scheduleActionReviewPool: '整理任務池',
        scheduleActionReviewPoolBody: '先選出值得排期的任務，再改 TT。',
        scheduleActionSyncTt: '同步 TT',
        scheduleActionSyncTtBody: '刷新今日、已完成、任務池和逾期狀態。',
        scheduleActionWeeklyReset: '本週重置',
        scheduleActionWeeklyResetBody: '總結風險，提出更輕的週計畫。',
        scheduleRunInChat: '寫入 Chat',
        scheduleChatPanelTitle: 'Chat 交接區',
        schedulePromptReady: '指令已準備',
        schedulePromptEmpty: '暫無指令',
        scheduleChatPanelReady: ({ action }: { action: string }) => `${action} 已寫入 Chat。檢查後即可送出。`,
        scheduleChatPanelEmpty: '點擊模組或快捷指令，先準備一條理解 TT 協議的 prompt，再在 Chat 裡繼續。',
        scheduleChatCollapsed: 'Chat 一直保留，用來補上下文或確認 TT 寫操作。',
        machineOffline: '機器離線',
