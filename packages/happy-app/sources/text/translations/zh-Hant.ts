...
export const zhHant: TranslationStructure = {
    ...
    agents: {
        ...
        imageEffectNeedsPhoto: '請先加入照片',
        imageEffectMachineOffline: '執行機離線',
        ...
        imageStylePhotoToStyledMotion: '照片風格化',
        imageStyleJapaneseCinemaFilm: '日系真人電影',
        imageStyleJapaneseCinemaFilmHint: '自然 35mm 電影色彩、柔和現場光、真實膚質與安靜的觀察式構圖。',
        imageStyleHanddrawnAnimeFilm: '手繪動畫電影',
        imageStyleHanddrawnAnimeFilmHint: '精緻二維線稿、賽璐璐人物上色與有觸感的水彩水粉場景。',
        imageStyle90sCelAnimation: '90年代賽璐璐',
        imageStyle90sCelAnimationHint: '手工勾線、兩階賽璐璐陰影、手繪背景與克制的類比顆粒。',
        imageStyleSeinenMangaBw: '黑白青年漫畫',
        imageStyleSeinenMangaBwHint: '精準成人漫畫線條、羽化陰影、穩定網點與純黑白灰層次。',
        imageStyleCyberpunkGraphicNovel: '賽博朋克繪本',
        imageStyleCyberpunkGraphicNovelHint: '醒目墨線、繪畫式賽璐璐陰影、局部網點與克制的青品紅光。',
        imageStyleAbstractScreenprintCollage: '抽象絲網拼貼',
        imageStyleAbstractScreenprintCollageHint: '孔版印刷墨色、剪紙幾何、錯版肌理與聚焦的五色調色板。',
        imageStyleInkWashPortrait: '水墨肖像',
        imageStyleInkWashPortraitHint: '層疊炭墨筆觸、礦物灰暈染、紙張肌理與克制朱砂點色。',
        imageStyleVintageEditorialFilm: '復古雜誌膠片',
        imageStyleVintageEditorialFilmHint: '真實 1970-90 年代雜誌人像質感，帶觸感顆粒與平衡的褪色色彩。',
        imageStyleCinematicRealism: '電影寫實',
        imageStyleCinematicRealismHint: '忠於人物身分的真人電影肖像，使用受控光線、精煉反差與電影色彩。',
