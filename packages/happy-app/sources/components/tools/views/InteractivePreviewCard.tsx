        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface, borderColor: theme.colors.divider }]} testID="interactive-preview-card">
            <View style={styles.titleRow}>
                ...
                <View style={styles.copy}>
                    ...
                    <Text style={[styles.provider, { color: theme.colors.textSecondary }]}>{t(preview.provider === 'cloudflare' ? 'interactivePreviews.cloudflareProvider' : 'interactivePreviews.provider')}</Text>
            ...
            {preview.provider === 'cloudflare' ? <Text style={[styles.expiry, { color: theme.colors.textSecondary }]}>{t('interactivePreviews.sessionLifetime')}</Text> : null}
