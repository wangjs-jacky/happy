...
<style>
html,body{margin:0;width:100%;height:100%;overflow:hidden;background:${props.kind === 'audio' ? 'transparent' : '#000'}}
${tag}{display:block;width:100%;height:100%;object-fit:contain;background:${props.kind === 'audio' ? 'transparent' : '#000'}}
</style>
</head>
<body>
<${tag} controls${autoPlay} playsinline webkit-playsinline preload="metadata"${poster} aria-label="${title}">
...
export function MediaAttachmentPlayer(props: MediaAttachmentPlayerProps) {
    ...
    return (
        <WebView
            ...
            mediaPlaybackRequiresUserAction={!props.autoPlay}
