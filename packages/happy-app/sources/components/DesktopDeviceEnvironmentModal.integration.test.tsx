...
const controller: EnvironmentDashboardController = {
    rows: [], scanning: false, running: false,
    scan: vi.fn(), update: vi.fn(), runSingle: vi.fn(), confirmStopped: vi.fn(), getCandidates: () => [],
};
