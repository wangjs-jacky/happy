...
const CO_AUTHORED_CREDITS = (() => trimIdent(`
    When making commit messages, instead of just giving co-credit to Claude, also give credit to Paws like so:

    <main commit message>

    Generated with [Claude Code](https://claude.ai/code)
    via [Paws](https://paws.build)

    Co-Authored-By: Claude <noreply@anthropic.com>
    Co-Authored-By: Paws <noreply@paws.build>
`))();
