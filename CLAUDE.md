...
- **版本浏览站**（公开）：<https://happy-app-ota-jacky.oss-cn-hangzhou.aliyuncs.com/site/index.html>
  列出 preview 频道全部历史版本（commit/时间），每行一个二维码，手机扫码即把本机锁定到该版本。
  网站源码 `packages/happy-app/ota-server/site/index.html`，改完用 `ossutil cp site/index.html oss://happy-app-ota-jacky/site/index.html --acl public-read -f` 重传。
