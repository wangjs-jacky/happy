...
const managed = `${RUNTIME_CONFIG_START}<script>(function(){var l=globalThis.location;if(!l||l.protocol!=="https:"||!["app.paws.rodeo","paws.rodeo","47.115.228.20","121.43.32.242"].includes(l.hostname))return;globalThis.__HAPPY_CONFIG__=Object.assign({},globalThis.__HAPPY_CONFIG__,{serverUrl:l.origin});})();</script>${RUNTIME_CONFIG_END}`;
